...
public class Mappp {
    public static void main(String[] args) {
        ...
        Map<String, Integer> maa=new HashMap<>();
        maa.put("apple",1);
        maa.put("banana",2);
...
//String input="abcabcbb"; //sliding window problem
        ...
        System.out.println(m3+"Updated Banana value to 5");
        ...
        Map<String,Integer> mapSent=new HashMap<>();
        for(String strSent:sent){
            mapSent.put(strSent,mapSent.getOrDefault(strSent,0)+1);
        }
        for(Map.Entry<String,Integer> entry:mapSent.entrySet()){
            System.out.println(entry.getKey()+" ; "+entry.getValue());
        }
        System.out.println(mapSent);


        String strCap="Hello there, I am Swetha and I work in Automation"; //Hello I Swetha I Automation
        String[] strcap=strCap.split(" ");
